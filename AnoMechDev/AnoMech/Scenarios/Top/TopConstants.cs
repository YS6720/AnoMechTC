...
public static class TopConstants
{
    ...
    public static class BNpcBaseId
    {
        ...
        public const uint P3MonitorBoss = 15717;             // P3 monitor boss (recording object)
        public const uint P3MonitorHelper = 9020;            // P3 31597 circle helper
    ...
    public static class BNpcNameId
    {
        ...
        public const uint P3MonitorBoss = 7636;         // P3 monitor boss (recording object)
        public const uint P3MonitorHelper = 7695;       // P3 helper name
    ...
    public static class ActionId
    {
        ...
        // -- P3 monitor / Wave Cannon / Oversampled / Diffuse --
        public const uint P3MonitorRight = 31595;              // P3 boss cast: right, field east
        public const uint P3MonitorLeft = 31596;               // P3 boss cast: left, field west
        public const uint P3MonitorCircle = 31597;             // P3 helper -> target, radius 7
        ...
        // -- P4 Blue Screen --
        // P4SpreadRepeat reuses WaveCannon_7B80 (31616). Rapid-fire ring visuals
        // reuse TopP3IntermissionRules.ActionId.WaveRepeaterFirst..Fourth (31567..31570).
    ...
    public static class LockonId
    {
        ...
        /// <summary>順序＝攻略的「〇×▽□」（畫出圖形要幾條線：1／2／3／4）。**這不是隨便排的**：
        /// 場景用 pair index 當索引發符號（P2 是 <c>Playstation[i/2]</c>），而 AI 又用同一個 index
        /// 決定那組站由北到南第幾排 ⇒ **這個陣列的順序就是玩家看到的符號由北到南的順序**。
        /// 排錯的話畫面會是「×□〇▽」而 AI 照「〇×▽□」搬人，兩邊各自看起來都正常
        /// （維護者 2026-09-05 回報）。</summary>
