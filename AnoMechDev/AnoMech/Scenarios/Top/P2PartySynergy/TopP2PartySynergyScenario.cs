...
public sealed class TopP2PartySynergyScenario : IScenario
{
    ...
    public void Run(SimWorld worldParam, int? selectedAi)
    {
        ...
        // The last recorded native boundary is the final sword clone warp-out/despawn
        // at 38.71s; success is explicit rather than inferred from queue exhaustion.
        world.Events.Add(38.71f, world.CompleteScenario);
    }
