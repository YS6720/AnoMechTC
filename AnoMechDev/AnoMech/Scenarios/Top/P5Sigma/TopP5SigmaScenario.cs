...
public sealed class TopP5SigmaScenario : IScenario
{
    ...
    public IReadOnlyList<IScenarioAi> AiStrats => [new TopP5SigmaAi(), new TopP5SigmaTuuuflessAi(), new TopP5SigmaMoogleAi()];
    ...
    public void Run(SimWorld worldParam, int? selectedAi)
    {
        ...
        Run_OtherDebuffs();
        Run_PlayerLockons();
        world.Events.Add(66.2f, world.CompleteScenario);
    }
    ...
    private void ResolveFailedTower(SimEnemy? omega4000A408)
    {
        ...
        party.WipeAllPlayers("清除記憶污染S—塔位無人");
    }
