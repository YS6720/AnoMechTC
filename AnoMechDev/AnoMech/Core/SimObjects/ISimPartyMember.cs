...
public static class SimCharacterDeathExtensions
{
    ...
    extension(SimCharacter c)
    {
        ...
        public bool Die(string cause, bool reportProtectedFailure = true)
        {
            if (c is ISimPartyMember pm) return Plugin.GameInstance.Kill(pm, cause, reportProtectedFailure);
